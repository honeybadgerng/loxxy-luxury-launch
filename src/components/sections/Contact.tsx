  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        title: "Message sent!",
        description:
          "Thank you for your inquiry. Lola's team will respond shortly.",
      });
      setFormData({
        name: "",
        company: "",
          ...
          <div>
            <div className="mb-10">
              ...
              <p className="mb-6 text-muted-foreground">
                For collaboration inquiries, bookings, or more information about
                working with Lola, please reach out through any of the following
                channels:
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:inquirydrop@gmail.com"
                      className="text-muted-foreground hover:text-gold"
                    >
                      inquirydrop@gmail.com
                    </a>
                  </div>
                </div>
            ...
            <div className="border-t pt-10">
              ...
              <p className="text-muted-foreground">
                All inquiries are typically responded to within 24-48 hours
                during business days. For urgent matters, please indicate so in
